 ...
 */
public class PathButton_old extends Button {
    ...
    public PathButton_old(Context context) {
        this(context, null);
    }

    public PathButton_old(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public PathButton_old(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PathButton_old);

        mPathWidth = typedArray.getDimension(R.styleable.PathButton_old_pathOldWidth, ResUtil.dpToPx(getResources(), mPathWidth));
        mPathOffset = (int) typedArray.getDimension(R.styleable.PathButton_old_pathOldOffset, mPathWidth / 2);
        mPathColor = typedArray.getColor(R.styleable.PathButton_old_pathOldColor, mPathColor);
        mDrawStep = typedArray.getInteger(R.styleable.PathButton_old_pathOldDrawStep, mDrawStep);
        mDrawDelay = typedArray.getInteger(R.styleable.PathButton_old_pathOldDrawDelay, mDrawDelay);
        mStartGravity = typedArray.getInteger(R.styleable.PathButton_old_pathOldStartGravity, mStartGravity);

        mIsBorderStyle = typedArray.getBoolean(R.styleable.PathButton_old_pathOldBorderStyle, mIsBorderStyle);
        mBorderWidth = typedArray.getDimension(R.styleable.PathButton_old_pathOldBorderWidth, ResUtil.dpToPx(getResources(), mBorderWidth));
        mBorderRound = typedArray.getDimension(R.styleable.PathButton_old_pathOldBorderRound, ResUtil.dpToPx(getResources(), mBorderRound));
        mBorderColor = typedArray.getColor(R.styleable.PathButton_old_pathOldBorderColor, mBorderColor);
...
//        e("XUtil-->" + curPoint.XUtil + " y-->" + curPoint.y);
//        e("XUtil-->" + curPoint.XUtil + " y-->" + curPoint.y);
