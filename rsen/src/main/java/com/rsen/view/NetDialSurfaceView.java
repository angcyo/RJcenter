 ...
 */
public class NetDialSurfaceView extends DialSurfaceView {

    private String[] icoUrl;//奖项图片
    private Map<String, Integer> awardMap;//奖项id, 与在转盘上索引对应的关系

    public NetDialSurfaceView(Context context) {
        this(context, null);
    }

    public NetDialSurfaceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetDialSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
