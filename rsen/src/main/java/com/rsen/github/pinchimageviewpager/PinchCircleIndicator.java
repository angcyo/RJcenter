 ...
 */
public class PinchCircleIndicator extends View implements PinchImageViewPager.OnPageChangeListener {
    ...
    public void setViewPager(PinchImageViewPager viewPager) {
        if (viewPager != null) {
