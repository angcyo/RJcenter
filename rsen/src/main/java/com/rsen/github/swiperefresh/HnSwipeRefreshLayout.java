 ...
 * </p>
 */
public class HnSwipeRefreshLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = HnSwipeRefreshLayout.class.getSimpleName();
  ...
  /*  public void setProgressViewOffset(boolean scale, int start, int end) {
     ...
     * @param attrs
     */
    public HnSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.HnSwipeRefreshLayout);
        SwipeRefreshLayoutDirection direction
                = SwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.HnSwipeRefreshLayout_srl_direction, 0));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       /* if (!mMeasured) { //add by liulonglong
            mMeasured = true;
