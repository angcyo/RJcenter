...
public class MoviePlayer {
    ...
    WeakReference<VideoTextureView> viewWeakReference;
    ...
    public MoviePlayer(File sourceFile, WeakReference<VideoTextureView> viewWeakReference)
            throws IOException {
        this(sourceFile, viewWeakReference, null);
    }


    public MoviePlayer(File sourceFile, WeakReference<VideoTextureView> viewWeakReference, FrameCallback frameCallback)
            throws IOException {
        this.viewWeakReference = viewWeakReference;
        VideoTextureView videoTextureView = viewWeakReference.get();
        SurfaceTexture st = videoTextureView.getSurfaceTexture();
        Surface surface = new Surface(st);
        init(sourceFile, surface, frameCallback);
    }
    ...
    public MoviePlayer(File sourceFile, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
        init(sourceFile, outputSurface, frameCallback);
    }
    ...
    private void init(File sourceFile, Surface outputSurface, FrameCallback frameCallback) throws IOException {
