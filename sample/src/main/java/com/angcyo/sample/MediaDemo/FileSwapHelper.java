...
public class FileSwapHelper {
    ...
    public static String BASE_VIDEO = "/video_mr/";
    ...
    /**
     * @param checkPath 清理之后,需要再次检查的剩余空间的路径
     * @param fullPath  需要清理的文件夹
     */
    public static void cleanFolder(String fullPath, String checkPath) {
     ...
     * 剩余空间是否小于20%
     */
    public static boolean checkCardSpace(String filePath) {
...
//            FileUtils.clearLostDirFolder();
    ...
    private void checkSpace(@Card int card) {
        ...
        if (checkCardSpace(checkPath)) {
            cleanFolder(fullPath.toString(), checkPath);
